...
event_page_eyebrow=the Events landing card and ticket-detail card use the same enlarged `UPFORIT presents` sticker with a yellow field, black border, black text and pink offset shadow; the Home card retains its separate compact treatment
