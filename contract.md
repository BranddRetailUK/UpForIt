...
/admin=staff/admin testing control centre for metrics, automatic tier status, ticket purchases excluding expired checkouts, emails, Stripe events, ticket resend, and an admin-only Testing purchase simulator
