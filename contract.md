...
events_landing_eyebrow=the Events landing-card `UPFORIT presents` sticker uses an enlarged yellow field with black border, white text and pink offset shadow; this desktop treatment is scoped away from the Home card
