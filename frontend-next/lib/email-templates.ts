  ...
  return `<table class="ufi-cta" role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;margin:26px 0 22px">
    <tr>
      <td bgcolor="#d90062" style="border:3px solid #050505;background-color:#d90062;background-image:linear-gradient(#d90062,#d90062)">
        <a href="${safeEmailUrl(url)}" style="display:inline-block;padding:14px 22px;color:#ffffff!important;-webkit-text-fill-color:#ffffff!important;font-family:Arial,Helvetica,sans-serif;font-size:16px;font-weight:900;line-height:20px;text-decoration:none;text-transform:uppercase">${escapeHtml(label)}</a>
      </td>
    </tr>
  </table>`;
}
...
function directLink(url: string) {
  ...
  return `<p style="margin:0;color:#4a4a4a!important;-webkit-text-fill-color:#4a4a4a!important;font-family:Arial,Helvetica,sans-serif;font-size:12px;line-height:18px">Button not working? Copy and paste this secure link:<br><a href="${href}" style="color:#0065d9!important;-webkit-text-fill-color:#0065d9!important;text-decoration:underline;word-break:break-all">${href}</a></p>`;
}
...
function inlineTicketQrCode(contentId: string, ticketNumber?: string) {
  ...
  return `<table class="ufi-ticket-qr" role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffdf00" style="width:100%;border-collapse:collapse;margin:24px 0;background-color:#ffdf00;background-image:linear-gradient(#ffdf00,#ffdf00)">
    <tr>
      <td align="center" style="border:3px solid #050505;padding:20px;color:#050505!important;-webkit-text-fill-color:#050505!important;font-family:Arial,Helvetica,sans-serif;text-align:center">
  ...
  <head>
    ...
    <style>
      ...
      @media (prefers-color-scheme:dark) {
        .ufi-email-gutter,
        .ufi-force-light { background-color:#ffffff!important;background-image:linear-gradient(#ffffff,#ffffff)!important;color:#050505!important;-webkit-text-fill-color:#050505!important; }
      }
      [data-ogsc] .ufi-email-gutter,
      [data-ogsc] .ufi-force-light { background-color:#ffffff!important;background-image:linear-gradient(#ffffff,#ffffff)!important;color:#050505!important;-webkit-text-fill-color:#050505!important; }
    </style>
  </head>
  <body class="ufi-email-gutter" style="margin:0;padding:0;background-color:#ffffff;background-image:linear-gradient(#ffffff,#ffffff);color:#050505!important;-webkit-text-fill-color:#050505!important;color-scheme:light only;supported-color-schemes:light">
    <div style="display:none;max-height:0;overflow:hidden;opacity:0;color:transparent;mso-hide:all">${escapeHtml(preheader)}</div>
    <table class="ufi-email-gutter" role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff" style="width:100%;border-collapse:collapse;background-color:#ffffff;background-image:linear-gradient(#ffffff,#ffffff);color:#050505!important;-webkit-text-fill-color:#050505!important">
      <tr>
        <td align="center" style="padding:28px 12px">
          <table role="presentation" width="640" border="0" cellpadding="0" cellspacing="0" style="width:100%;max-width:640px;border-collapse:collapse">
            <tr>
              <td align="center" bgcolor="#008ef0" style="padding:18px 20px;background-color:#008ef0;background-image:linear-gradient(#008ef0,#008ef0)">
            ...
            <tr>
              <td bgcolor="#d90062" style="padding:0 8px 8px 0;background-color:#d90062;background-image:linear-gradient(#d90062,#d90062)">
                <table class="ufi-force-light" role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff" style="width:100%;border-collapse:collapse;background-color:#ffffff;background-image:linear-gradient(#ffffff,#ffffff);color:#050505!important;-webkit-text-fill-color:#050505!important">
                  <tr>
                    <td class="ufi-mobile-centre" style="border:4px solid #050505;padding:34px 30px;color:#050505!important;-webkit-text-fill-color:#050505!important">
                      ${testingBanner}
                      <table class="ufi-kicker" role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;margin:0 0 16px">
                        <tr><td bgcolor="#ffdf00" style="border:2px solid #050505;padding:6px 10px;background-color:#ffdf00;background-image:linear-gradient(#ffdf00,#ffdf00);color:#050505!important;-webkit-text-fill-color:#050505!important;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:900;letter-spacing:.7px;line-height:14px;text-transform:uppercase">${escapeHtml(eyebrow)}</td></tr>
                      </table>
                      <h1 style="margin:0 0 24px;color:#050505!important;-webkit-text-fill-color:#050505!important;font-family:Arial Black,Arial,Helvetica,sans-serif;font-size:34px;font-weight:900;letter-spacing:-1px;line-height:38px;text-transform:uppercase">${escapeHtml(title)}</h1>
                      ${bodyHtml}
                      <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#dfeef8" style="width:100%;border-collapse:collapse;margin:28px 0 0;background-color:#dfeef8;background-image:linear-gradient(#dfeef8,#dfeef8)">
                        <tr>
                          ...
                          <td style="padding:14px 16px;color:#050505!important;-webkit-text-fill-color:#050505!important;font-family:Arial,Helvetica,sans-serif;font-size:13px;line-height:19px"><strong style="text-transform:uppercase">${escapeHtml(noticeTitle)}</strong><br>${escapeHtml(noticeText)}</td>
                        </tr>
                      </table>
                    </td>
                  </tr>
            ...
            <tr><td height="18" style="height:18px;font-size:0;line-height:0">&nbsp;</td></tr>
            <tr>
              <td class="ufi-mobile-centre" bgcolor="#050505" style="border:4px solid #050505;padding:20px 24px;background-color:#050505;background-image:linear-gradient(#050505,#050505);color:#ffffff!important;-webkit-text-fill-color:#ffffff!important;font-family:Arial,Helvetica,sans-serif;font-size:12px;line-height:18px">
                <strong style="color:#ffdf00!important;-webkit-text-fill-color:#ffdf00!important;font-size:14px;text-transform:uppercase">Good vibes only.</strong><br>Respect the ravers. No bad energy.<br>
                <a href="${homeUrl}" style="color:#ffffff!important;-webkit-text-fill-color:#ffffff!important;text-decoration:underline">upforitevents.co.uk</a>
              </td>
            </tr>
            <tr><td style="padding:14px 20px 0;color:#050505!important;-webkit-text-fill-color:#050505!important;font-family:Arial,Helvetica,sans-serif;font-size:11px;line-height:16px;text-align:center">This is a transactional email from UPFORIT Events.</td></tr>
          </table>
        </td>
      </tr>
    </table>
...
export function verificationEmailHtml({ displayName, url, siteUrl, originalRecipient }: AuthEmailOptions) {
  return emailShell({
    ...
    bodyHtml: `<p style="margin:0 0 14px;color:#050505!important;-webkit-text-fill-color:#050505!important;font-family:Arial,Helvetica,sans-serif;font-size:17px;line-height:26px">Hi <strong>${escapeHtml(displayName)}</strong>,</p>
      <p style="margin:0;color:#050505!important;-webkit-text-fill-color:#050505!important;font-family:Arial,Helvetica,sans-serif;font-size:16px;line-height:25px">Your UPFORIT account is nearly ready. Verify your email to activate it, sign in and get back to the tickets.</p>
...
export function resetPasswordEmailHtml({ displayName, url, siteUrl, originalRecipient }: AuthEmailOptions) {
  return emailShell({
    ...
    bodyHtml: `<p style="margin:0 0 14px;color:#050505!important;-webkit-text-fill-color:#050505!important;font-family:Arial,Helvetica,sans-serif;font-size:17px;line-height:26px">Hi <strong>${escapeHtml(displayName)}</strong>,</p>
      <p style="margin:0;color:#050505!important;-webkit-text-fill-color:#050505!important;font-family:Arial,Helvetica,sans-serif;font-size:16px;line-height:25px">We received a request to reset your UPFORIT password. Use the secure button below to choose a new one.</p>
...
export function ticketConfirmationEmailHtml({
  ...
  return emailShell({
    ...
    bodyHtml: `<p style="margin:0 0 14px;color:#050505!important;-webkit-text-fill-color:#050505!important;font-family:Arial,Helvetica,sans-serif;font-size:17px;line-height:26px">Hi <strong>${escapeHtml(displayName)}</strong>,</p>
      <p style="margin:0 0 22px;color:#050505!important;-webkit-text-fill-color:#050505!important;font-family:Arial,Helvetica,sans-serif;font-size:16px;line-height:25px">${hasSingleTicketQr
      ...
      <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0" style="width:100%;border-collapse:collapse">
        <tr><td class="ufi-ticket-step-number" width="36" valign="top" style="padding:0 0 12px;color:#d90062!important;-webkit-text-fill-color:#d90062!important;font-family:Arial Black,Arial,sans-serif;font-size:20px;font-weight:900">01</td><td class="ufi-ticket-step-copy" valign="top" style="padding:1px 0 12px;color:#050505!important;-webkit-text-fill-color:#050505!important;font-family:Arial,Helvetica,sans-serif;font-size:14px;line-height:20px"><strong>Download the attached PDF</strong> and save it to your phone.</td></tr>
        <tr><td class="ufi-ticket-step-number" width="36" valign="top" style="padding:0 0 12px;color:#d90062!important;-webkit-text-fill-color:#d90062!important;font-family:Arial Black,Arial,sans-serif;font-size:20px;font-weight:900">02</td><td class="ufi-ticket-step-copy" valign="top" style="padding:1px 0 12px;color:#050505!important;-webkit-text-fill-color:#050505!important;font-family:Arial,Helvetica,sans-serif;font-size:14px;line-height:20px"><strong>${hasSingleTicketQr ? "Keep your QR code private" : "Bring every ticket you purchased"}</strong>${hasSingleTicketQr ? " until you reach the entrance." : " for your group."}</td></tr>
        <tr><td class="ufi-ticket-step-number" width="36" valign="top" style="padding:0;color:#d90062!important;-webkit-text-fill-color:#d90062!important;font-family:Arial Black,Arial,sans-serif;font-size:20px;font-weight:900">03</td><td class="ufi-ticket-step-copy" valign="top" style="padding:1px 0 0;color:#050505!important;-webkit-text-fill-color:#050505!important;font-family:Arial,Helvetica,sans-serif;font-size:14px;line-height:20px"><strong>${hasSingleTicketQr ? "Show the QR code at entry" : "Show each QR code at entry"}</strong> for quick check-in.</td></tr>
      </table>
