import { CLOUDINARY_ASSETS, type CloudinaryAsset } from "./cloudinary";
...
function paddedEmailAsset(asset: CloudinaryAsset, background: string, width: number, height: number) {
  const transformation = `f_png,q_auto,c_pad,b_rgb:${background},w_${width},h_${height}`;
  return `https://res.cloudinary.com/brandduk/image/upload/${transformation}/${asset.publicId}.${asset.format}`;
}
...
function emailShell({
  ...
  const upforitLogoUrl = safeEmailUrl(paddedEmailAsset(CLOUDINARY_ASSETS.navLogo, "050505", 600, 210));
  const summerRoundupLogoUrl = safeEmailUrl(paddedEmailAsset(CLOUDINARY_ASSETS.summerRoundup, "008ef0", 700, 420));
...
<html lang="en">
  ...
  <body style="margin:0;padding:0;background-color:#008ef0;background-image:linear-gradient(#008ef0,#008ef0);color:#050505!important;color-scheme:light only">
    <div style="display:none;max-height:0;overflow:hidden;opacity:0;color:transparent;mso-hide:all">${escapeHtml(preheader)}</div>
    <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#008ef0" style="width:100%;border-collapse:collapse;background-color:#008ef0;background-image:linear-gradient(#008ef0,#008ef0)">
      <tr>
        <td align="center" style="padding:28px 12px">
          <table role="presentation" width="640" border="0" cellpadding="0" cellspacing="0" style="width:100%;max-width:640px;border-collapse:collapse">
            <tr>
              <td align="center" bgcolor="#050505" style="border:4px solid #050505;padding:14px 20px;background-color:#050505;background-image:linear-gradient(#050505,#050505)">
                <img src="${upforitLogoUrl}" width="300" height="105" alt="UPFORIT" style="display:block;width:300px;max-width:100%;height:auto;border:0;color:#ffffff;font-family:Arial Black,Arial,Helvetica,sans-serif;font-size:28px;font-weight:900">
              </td>
            </tr>
            <tr>
              <td align="center" bgcolor="#008ef0" style="border-right:4px solid #050505;border-left:4px solid #050505;padding:12px 20px;background-color:#008ef0;background-image:linear-gradient(#008ef0,#008ef0)">
                <img src="${summerRoundupLogoUrl}" width="350" height="210" alt="The Summer Roundup" style="display:block;width:350px;max-width:100%;height:auto;border:0;color:#050505;font-family:Arial Black,Arial,Helvetica,sans-serif;font-size:24px;font-weight:900">
              </td>
            </tr>
            <tr>
              <td style="border-right:4px solid #050505;border-left:4px solid #050505">
            ...
            <tr>
              <td bgcolor="#d90062" style="padding:0 8px 8px 0;background-color:#d90062;background-image:linear-gradient(#d90062,#d90062)">
                <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff" style="width:100%;border-collapse:collapse;background-color:#ffffff;background-image:linear-gradient(#ffffff,#ffffff)">
                  <tr>
                    <td style="border:4px solid #050505;padding:34px 30px;color:#050505!important">
                      ${testingBanner}
            ...
            <tr><td height="18" style="height:18px;font-size:0;line-height:0">&nbsp;</td></tr>
            <tr>
              <td bgcolor="#050505" style="border:4px solid #050505;padding:20px 24px;background-color:#050505;background-image:linear-gradient(#050505,#050505);color:#ffffff!important;font-family:Arial,Helvetica,sans-serif;font-size:12px;line-height:18px">
...
export function ticketConfirmationEmailHtml({ displayName, accountUrl, siteUrl, originalRecipient }: TicketEmailOptions) {
  return emailShell({
    ...
    bodyHtml: `<p style="margin:0 0 14px;color:#050505!important;font-family:Arial,Helvetica,sans-serif;font-size:17px;line-height:26px">Hi <strong>${escapeHtml(displayName)}</strong>,</p>
      <p style="margin:0 0 22px;color:#050505!important;font-family:Arial,Helvetica,sans-serif;font-size:16px;line-height:25px">You’re in! Your printable UPFORIT tickets are attached as one PDF, with one ticket and one unique QR code per page.</p>
      <table role="presentation" width="100%" border="0" cellpadding="0" cellspacing="0" style="width:100%;border-collapse:collapse">
        <tr><td width="36" valign="top" style="padding:0 0 12px;color:#d90062!important;font-family:Arial Black,Arial,sans-serif;font-size:20px;font-weight:900">01</td><td valign="top" style="padding:1px 0 12px;color:#050505!important;font-family:Arial,Helvetica,sans-serif;font-size:14px;line-height:20px"><strong>Download the attached PDF</strong> and save it to your phone.</td></tr>
        <tr><td width="36" valign="top" style="padding:0 0 12px;color:#d90062!important;font-family:Arial Black,Arial,sans-serif;font-size:20px;font-weight:900">02</td><td valign="top" style="padding:1px 0 12px;color:#050505!important;font-family:Arial,Helvetica,sans-serif;font-size:14px;line-height:20px"><strong>Bring every ticket you purchased</strong> for your group.</td></tr>
        <tr><td width="36" valign="top" style="padding:0;color:#d90062!important;font-family:Arial Black,Arial,sans-serif;font-size:20px;font-weight:900">03</td><td valign="top" style="padding:1px 0 0;color:#050505!important;font-family:Arial,Helvetica,sans-serif;font-size:14px;line-height:20px"><strong>Show each QR code at entry</strong> for quick check-in.</td></tr>
      </table>
